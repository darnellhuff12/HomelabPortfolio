...
| Live traffic validation | Kali-to-victim traffic, Security Onion packet capture visibility, Security Onion Hunt results, Zeek connection logs, Nmap SYN scan visibility, service enumeration results, SSH brute-force activity, web application scan traffic, Kali-to-Admin blocking, Admin/Bastion access, filtered management-plane access, saved scan output, and pfSense firewall rule behavior validated across Projects 2, 4, 5, 6, 7, and 8 |
