...
Welcome to my cybersecurity homelab portfolio. This collection of projects documents hands-on experience with network segmentation, monitoring, virtualization, and security tooling.

## Projects Overview

| # | Project Name | Description | Status |
| --- | --- | --- | --- |
| 01 | [Network Segmentation and VLAN Setup](./01-network-segmentation/) | Configured VLANs and firewall rules on pfSense and Netgear switch to segment traffic and isolate attacker, victim, and admin networks. | Complete |
| 02 | [Security Onion Deployment and Monitoring](./02-security-onion/) | Deployed Security Onion sensor for network traffic monitoring and alerting, integrated with Zeek and Suricata. | Complete |
| 03 | [Proxmox Virtualization Host Setup](./03-proxmox-setup/) | Installed and configured Proxmox VE to host lab VMs including Kali, Security Onion, and victim hosts. | Complete |
| 04 | [Firewall Rule Validation and Testing](./04-firewall-validation/) | Tested firewall rules for correct VLAN isolation and access control using ping, traceroute, and port scans. | Complete |
| 05 | [Blue Team Monitoring and Alerting](./05-blue-team-monitoring/) | Created detection rules and alerts in Security Onion to identify suspicious activity and validate monitoring coverage. | Complete |
| 06 | [Service Enumeration and Exposure Review](./06-service-enumeration-and-exposure-review/) | Used Kali to perform controlled host discovery and service enumeration from the attacker VLAN, validated filtered management access, preserved Nmap output, and confirmed scan visibility in Security Onion Hunt/Zeek logs. | Complete |

## Portfolio Progress

All projects from 1 through 6 are now complete, demonstrating a comprehensive cybersecurity homelab with segmentation, monitoring, virtualization, firewall validation, blue team monitoring, and service enumeration.

## Current Status

- Completed Project 1: Network Segmentation and VLAN Setup
- Completed Project 2: Security Onion Deployment and Monitoring
- Completed Project 3: Proxmox Virtualization Host Setup
- Completed Project 4: Firewall Rule Validation and Testing
- Completed Project 5: Blue Team Monitoring and Alerting
- Completed Project 6: Service Enumeration and Exposure Review, validating attacker VLAN enumeration, restricted management access, saved Nmap evidence, and Security Onion visibility into scan activity.

## Portfolio Checklist

- [x] Project 1: Network Segmentation and VLAN Setup
- [x] Project 2: Security Onion Deployment and Monitoring
- [x] Project 3: Proxmox Virtualization Host Setup
- [x] Project 4: Firewall Rule Validation and Testing
- [x] Project 5: Blue Team Monitoring and Alerting
- [x] Project 6: Service Enumeration and Exposure Review

Thank you for reviewing my homelab portfolio. Feel free to explore each project folder for detailed documentation, commands, screenshots, and evidence of my hands-on work.
